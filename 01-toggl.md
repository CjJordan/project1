...
Your job is to create a clone of Toggl. The design and functionality should match Toggl exactly. This is not the time to get creative. This is the time to show off your ability to match design and project specs. 
...
1. Ability to start and stop timer and record data
2. Ability to add task name and associate with time
3. Ability to view total time on a given task
...
1. Graphically represent hours/minutes spent on tasks over time. 
2. Ability to add multiple projects and categorize tasks. 
3. Ability to manually add time on tasks.  
