...
Your job is to create a clone of Google Calendar. The design and functionality should match Google Calendar exactly. This is not the time to get creative. This is the time to show off your ability to match design and project specs. 
...
1. Ability to add, update, and delete events on the calendar.
2.  Ability to set event time based on click location.
3. Ability to scroll through months and years. 
...
1. Ability to set recurring events. 
2. Ability to view events in weekly, daily, or monthly view.
3. Ability to add multiple calendars.
4. Ability to invite other users to an event via emial. 
5. Ability to add event location with maps integration.
