...
Your job is to create a clone of WolframAlpha. The design and functionality should match WolframAlpha exactly. This is not the time to get creative. This is the time to show off your ability to match design and project specs. 
...
1. Ability to input arithmetic equations and see solutions displayed.
2. Ability to input alegraic equations and see solutions displayed.
3. Ability to input derivatives and see solutions displayed.
...
1. Display graphical representations of solutions.
2. Handle integrals, series, geometry, or other types of problems. 
3. Add in chemistry, physics engines, or others.
